...
var parseUrl = function parseUrl(url, structuredHash) {
...
var url = {
  parse: parseUrl,
  create: function create(options, structuredHash) {
  ...
  createPath: function createPath(pathname, query, hash, structuredHash) {
